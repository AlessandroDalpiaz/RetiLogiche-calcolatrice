...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {manualIntensity}]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {fadeSelect}]
...
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports leftButton]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports rightButton]
